					...
					<div class="col-md-8 mx-auto" style="margin-top: -10%;">
						<div class="card">
							<div class="card-body">
								...
								<hr>
								<form class="row g-2" method="POST" action="{{route('update-city')}}">
									{{csrf_field()}}
						          ...
						          <div class="col-md-2"></div>
									<div class="col-md-4">
										...
										<input type="text" class="form-control" id="inputFirstName" placeholder="City" name="city" value="{{$citys->city}}"  required/>
									</div>
						
									<div class="col-md-3" style="margin-top:5.5%;" >
								       <button type="submit" class="btn btn-primary px-3"><i class="fadeIn animated bx bx-plus"></i> Update City </button>
									</div>
								</form>

                                 ...
                                 <input type="hidden" name="id"  value="{{$mededit->id}}">
                                    ...
                                    @endphp
										...
										<label for="inputFirstName" class="form-label">Select City*</label>
                                         ...
                                         <option value="{{ $citys->id }}"  @if(in_array($mededit->id,$com)) selected @endif>
                                            {{$citys->city}} </option>
                                         @endforeach
									...
									<div class="col-md-3">
										...
										<input type="text" class="form-control" id="inputFirstName" placeholder=" Enter Password" name="password" value="{{$mededit->password}}">
									</div>

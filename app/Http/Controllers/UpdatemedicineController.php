...
class UpdatemedicineController extends Controller
{
    public function updatemedicinemas(){
      ...
      public function getMedicine(Request $request)
      
        {
          ...
          ->where('medicinesecond.select_company_id', $request->id)
  ...
  
      {
        ...
        $medicine_list=Add_medicine::where('medicinesecond_id',$medicinesecond->id)->get();
    ...
    //  }
     ...
     public function updatemedicineedit(Request $request)
     {
      ...
      $medicines=Add_medicine::where('id',$request->zero_scheme_id)->update([
     'gst'=>$request->get('gst'),
      ...
      $med=Add_medicine::find($request->ten_scheme_id);       
      ...
      $medi=Add_medicine::find($request->twenty_scheme_id);       
